...
function SuccessContent() {
  ...
  const whatsappMessage = orderId
    ? `Hi CRAVEK! I just placed an order (Order #${shortOrderId}). Can you confirm my order details? 🌶️`
    : `Hi CRAVEK! I just placed an order. Can you confirm the details? 🌶️`;
  ...
  return (
    <div className={styles.card}>
      ...
      <p className={styles.sub}>
        Your cravings are about to be satisfied. We have received your order and are firing up the woks.
      </p>

      {orderId && (
        <div className={styles.orderIdBlock}>
          <span className={styles.label}>Order Number</span>
          <span className={styles.orderId}>{shortOrderId}</span>
        </div>
      )}
